...
class Object {
 public:
  ...
  Object(const Vec3& position = Vec3(),
         ...
         const Vec3& color = Vec3(0.54f, 0.27f, 0.07f))
...
Camera camera;
Torus torus1;
Torus torus2(0.5f, 1.0f, 30, 30, Vec3(), Vec3(90.0f, 0.0f, 0.0f));
...
void Keyboard(int key, int x, int y) {
  ...
  switch (key) {
    case GLUT_KEY_LEFT:
      torus1.Rotate(rotationSpeed, 0.0f, 1.0f, 0.0f);
      torus2.Rotate(rotationSpeed, 0.0f, 1.0f, 0.0f);
      break;
    case GLUT_KEY_RIGHT:
      torus1.Rotate(-rotationSpeed, 0.0f, 1.0f, 0.0f);
      torus2.Rotate(-rotationSpeed, 0.0f, 1.0f, 0.0f);
      break;
    case GLUT_KEY_UP:
      torus1.Rotate(rotationSpeed, 1.0f, 0.0f, 0.0f);
      torus2.Rotate(rotationSpeed, 1.0f, 0.0f, 0.0f);
      break;
    case GLUT_KEY_DOWN:
      torus1.Rotate(-rotationSpeed, 1.0f, 0.0f, 0.0f);
      torus2.Rotate(-rotationSpeed, 1.0f, 0.0f, 0.0f);
